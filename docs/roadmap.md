...
### 1. Feature Lab v2 — completed foundation
...
### 3. Release Intelligence — completed first product pass

**Goal:** Claude Code 릴리즈 변화가 사용자에게 어떤 의미인지 해석하는 페이지를 만든다.

**Completed:**

- Home page Release Intelligence rail groups high-signal releases by practical impact.
- Release cards show why a rail item marked that release as important.
- Highlighted release cards provide a Feature Lab affordance when direct related-feature links are missing.
- Release Intelligence validation is wired into build/prebuild.

**Later candidate work:**

- Dedicated `/release-intelligence/` route.
- 릴리즈별 risk, migration note, impacted audience 요약.
- Version timeline 개선.
- More explicit Feature Lab ↔ release bidirectional navigation.

### 4. Config / Permission Simulator — selected next goal
...
Before implementing more UI, start **Config / Permission Simulator Goal 1** with a docs-backed implementation plan.

Completed immediately before this step:

- Feature Lab evidence pass introduced captured Claude Code provenance and validation.
- Release Intelligence Goal 1 added the home rail and build-time validator.
- Release Intelligence follow-up added release-card importance highlights and Feature Lab affordances.
- Preview and production verification were completed for the shipped Release Intelligence work.

Next product plan:

- `docs/plans/2026-05-21-config-permission-simulator-goal-1.md`

Supporting completed plans:

- Feature Lab evidence pass: `docs/plans/2026-05-20-feature-lab-captured-tui-evidence.md`
- Release Intelligence Goal 1: `docs/plans/2026-05-20-release-intelligence-goal-1-impact-summary.md`
- Completed Feature Lab v2 milestone plan: `docs/plans/2026-05-19-feature-lab-v2.md`
- Completed Goal 2 plan: `docs/plans/2026-05-19-feature-lab-v2-goal-2-selected-stack.md`
- Completed Goal 3 plan: `docs/plans/2026-05-19-feature-lab-v2-goal-3-fallback-empty-states.md`
- Completed Goal 4 plan: `docs/plans/2026-05-19-feature-lab-v2-goal-4-deeplink-qa.md`

Rationale: the site can now explain which releases matter and can show captured Feature Lab evidence. The next unanswered user question is practical configuration: “What changes if I enable this setting or permission pattern?”

**Recommended implementation PR:** `feat/config-permission-simulator-goal-1`

**Recommended merge point:** after the new route is discoverable from the home page, `validate:config-simulator` and existing validators pass, GitHub Pages preview verifies both home CTA and `/config-simulator/`, and production is verified after merge.
