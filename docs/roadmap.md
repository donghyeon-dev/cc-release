...
### 3. Release Intelligence — selected next goal
...
Before implementing **Release Intelligence Goal 1**, finish a short Feature Lab evidence pass so the terminal/TUI panel distinguishes captured Claude Code output from illustrative scenarios.

- Evidence pass plan: `docs/plans/2026-05-20-feature-lab-captured-tui-evidence.md`
- Next product plan after this pass: `docs/plans/2026-05-20-release-intelligence-goal-1-impact-summary.md`
...
Rationale: the daily release data is now closer to final structured form, but Feature Lab's terminal panel still needs real Claude Code capture provenance before more intelligence surfaces reuse those narratives.

**Recommended implementation PR:** `feat/claude-code-captured-tui-evidence`

**Recommended merge point:** after `validate-feature-lab` verifies capture references, the Feature Lab preview shows captured/scenario evidence labels, and production is verified after merge.
