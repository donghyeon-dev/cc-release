...
Complete **Feature Lab v2 Goal 4: Deep-Link and Static Export QA** in the current PR.
...
- Current goal plan: `docs/plans/2026-05-19-feature-lab-v2-goal-4-deeplink-qa.md`
- Recommended merge point: after the new deep-link validator passes in prebuild/postbuild, GitHub Pages preview deploy succeeds, and production routes are verified.
