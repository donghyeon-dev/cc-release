...
Move from the completed **Feature Lab v2 foundation** into **Release Intelligence Goal 1: Impact Summary Rail**.
...
- Next goal plan: `docs/plans/2026-05-20-release-intelligence-goal-1-impact-summary.md`

**Why this is next:** daily release data is now being collected in final structured form, and Feature Lab already provides related-feature context. The next visible product step is to turn the chronological release feed into a compact “what matters now” surface before building a larger dedicated Release Intelligence route.

**Recommended implementation PR:** `feat/release-intelligence-impact-rail`

**Recommended merge point:** after the derived release-intelligence validator passes, the home page rail renders in GitHub Pages preview, anchor links jump to existing release cards, and production is verified after merge.
