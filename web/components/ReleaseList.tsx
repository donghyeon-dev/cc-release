          ...
          {hasMore && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="px-5 py-2.5 rounded-md border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-sm font-medium text-zinc-700 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
              >
                더 보기 ({remaining}건 남음)
              </button>
            </div>
